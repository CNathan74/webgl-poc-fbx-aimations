import {DirectionalLight, Clock, AnimationMixer, sRGBEncoding, PerspectiveCamera, Scene, WebGLRenderer} from "three";
...
export class App {
  ...
  init() {
    ...
    //load car with animate wheels
    this.loaderFbx.load( 
      'models/fbx/Voiture_Exterieur_AnimationRoue_V00.fbx', 
      ( fbx ) => {
